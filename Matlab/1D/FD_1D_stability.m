...
theta=0:0.01:2*pi;
f=-i*(((exp(-i*theta)).^2.5-(exp(-i*theta)).^1.5));
...
theta=0:0.01:2*pi;
f=-i*(((exp(-i*theta)).^2.5-(exp(-i*theta)).^1.5)*1);
f2=(2*sum_fd_stencil.*(25/24.*(exp(-i*theta)).^2-1/12.*(exp(-i*theta)).^1+1/24));
f_ges=f./f2;
...
theta=0:0.01:2*pi;
f=-i*(((exp(-i*theta)).^3.5-(exp(-i*theta)).^2.5)*1);
f2=(2*sum_fd_stencil.*(13/12.*(exp(-i*theta)).^3-5/24.*(exp(-i*theta)).^2+1/6.*(exp(-i*theta)).^1-1/24));
f_ges=f./f2;
