%% FD_1D_DX4_DT3_ABS.m 1-D acoustic Finite-Difference modelling
...
for n=2:nt-1;
    ...
    for kx=5:nx-5;
        ...
        vx(kx)=vx(kx)...
            -dt/rho(kx)*(25/24*p_x(kx)-1/12*p_x2(kx)+1/24*p_x3(kx));
    end
    ...
    for kx=5:nx-5;
        ...
        p(kx)=p(kx)...
            -l(kx)*dt*(25/24*vx_x(kx)-1/12*vx_x2(kx)+1/24*vx_x3(kx));
    end
