%% FD_1D_DX8_DT2.m 1-D acoustic Finite-Difference modelling
...
% Spatial eighth-order accuracy  O(DX^8)
...
for n=2:nt-1;
    ...
    for kx=5:nx-5;
        ...
        p_x=+i_dx*(1225/1024)*(p(kx+1)-p(kx))...
            +i_dx*(-245/3072)*(p(kx+2)-p(kx-1))...
            +i_dx*(49/5120)*(p(kx+3)-p(kx-2))...
            +i_dx*(-5/7168)*(p(kx+4)-p(kx-3));
    ...
    for kx=5:nx-5;
        ...
        % Calculating spatial derivative
        vx_x=+i_dx*(1225/1024)*(vx(kx)-vx(kx-1))...
            +i_dx*(-245/3072)*(vx(kx+1)-vx(kx-2))...
            +i_dx*(49/5120)*(vx(kx+2)-vx(kx-3))...
            +i_dx*(-5/7168)*(vx(kx+3)-vx(kx-4));
